			...
			<div class="main zerogrid">
				...
				<nav>
					<ul class="menu">
						...
						<li><a class="active" href="index-2.php">Desarrollo fetal</a></li>
				...
				<!--<div class="row">-->
					<!--<article class="col-2-3"><div class="wrap-col">-->
						...
						<div class="wrapper p2">
							<div class="col-1-3"><figure class="img-indent"><img src="images/slider-img3.jpg" alt=""></figure></div> 
